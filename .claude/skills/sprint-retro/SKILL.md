...
Launches the `sprint-retro` agent which:
...
4. Saves data to CSV in `agents/sprint-retro/data/cache/`
5. Runs `generate-sprint-retro.ts` which computes: completion analysis, estimation accuracy, scope changes, carryover risk, blocker analysis, and automation opportunities
...
A markdown report saved to `agents/sprint-retro/data/output/sprint-retro-{date}.md` with:
