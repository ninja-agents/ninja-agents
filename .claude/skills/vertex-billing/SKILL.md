---
name: vertex-billing
description: Query Vertex AI Claude usage and calculate billing breakdown from Cloud Monitoring
user-invocable: true
---
...
- **Per-model breakdown** — token counts and costs for each Claude model used
